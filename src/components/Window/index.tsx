...
const Window = () => {
    ...
    return (
        <>
            <video onCanPlayThrough={() => video.updateStatus("loaded")} onLoadedMetadata={() => handleMetadataLoaded()}  autoPlay={true} muted={true} loop={true} playsInline={true} className={classes.window}>
